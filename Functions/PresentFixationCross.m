...
function [vbl,respMade,rt] = PresentFixationCross(window, vbl, ifi, color, Duration1, Duration2, GetResp, tStart, PreviousRespMade, rt)
%Plays a fixatoin cross for the given Duration in ms. Will generate a vbl if no vbl is given. Has ability to receive user input in form of key press or rt
%   
