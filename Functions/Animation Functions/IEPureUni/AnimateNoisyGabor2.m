function [AnimationTextures, responseWindowMatrix]= AnimateNoisyGabor2(AnimationTextures, gaborMatrix, noiseMatrices, responseWindowMatrix, coherence, duration, ifi, window, getResp)
