function [vbl,respMade,rt] = PresentAVStimulus(stimulusTexture, Frequency, Volume, window, vbl, ifi, Duration1, Duration2, GetResp, tStart, PreviousRespMade, rectCenter)
