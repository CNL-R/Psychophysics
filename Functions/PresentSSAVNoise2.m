function [vbl,respMade,rt] = PresentSSAVNoise2(textures, AudioMat, crossTexture, pahandle, volume, window, vbl, ifi, Duration1, Duration2, tStart, PreviousRespMade, rt, dstRects)
