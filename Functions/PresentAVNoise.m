function [vbl,respMade,rt] = PresentAnimatedNoise(textures, AudioMat, pahandle, volume, window, vbl, ifi, Duration1, Duration2, GetResp, tStart, PreviousRespMade, rt, rectCenter)
...
PsychPortAudio('FillBuffer', pahandle, AuidoMat);
