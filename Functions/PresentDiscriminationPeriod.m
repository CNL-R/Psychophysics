function [vbl,respMade,rt] = PresentDiscriminationPeriod(text, window, vbl, ifi, Duration1, Duration2, tStart, PreviousRespMade, rt, rectCenter)
%Plays a blank gray screen with text until the target responds. Will generate a vbl if no vbl is given. Has ability to receive user input in form of key press or rt. Works by
