...
filepath = 'C:\Users\achen52\Desktop\Psychophysics Data';
...
visualParameters(1,:) = [0 .025 .05 .075 .1 .125 .15 .175 .2 .3];  % Assigning coherences
...
audioParameters(1,:) = [0 .025 .05 .075 .1 .125 .15 .175 .2 .3];
