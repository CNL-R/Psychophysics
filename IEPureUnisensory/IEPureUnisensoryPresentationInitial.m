...
visualParameters(1,:) = 0:.05:1;  % Assigning coherences
...
frequency1 = 1000;                                             %To create a ripple, two sine waves are dot multiplied with each other 
frequency2 = 200;
audioParameters = zeros(1, gradationsPerCondition);
audioParameters(1,:) = 0:.05:1;
